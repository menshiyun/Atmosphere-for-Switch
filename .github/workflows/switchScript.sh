...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/menshiyun/Atmosphere/releases/latest \
  | jq '.name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/easyworld/hekate/releases/latest \
  | jq '.name' \
  | xargs -I {} echo {} >> ../description.txt
curl -H "$API_TOKEN" -sL https://api.github.com/repos/easyworld/hekate/releases/latest \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/impeeza/sys-patch/releases/latest \
  | jq '.name' \
  | xargs -I {} echo {} >> ../description.txt
curl -H "$API_TOKEN" -sL https://api.github.com/repos/impeeza/sys-patch/releases/latest \
...
#curl -H "$API_TOKEN" -sL https://api.github.com/repos/Decscots/Lockpick_RCM/releases/latest \
#  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/Lockpick_RCMDecScots/releases/latest \
  | jq '.tag_name' \
  | xargs -I {} echo Lockpick_RCM {} >> ../description.txt
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/Lockpick_RCMDecScots/releases/latest \
  | grep -oP '"browser_download_url": "\Khttps://[^"]*Lockpick_RCM.bin"' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/TegraExplorer/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/CommonProblemResolver/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/meganukebmp/Switch_90DNS_tester/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/rashevskyv/dbi/releases/latest \
  | jq '.name' \
  | xargs -I {} echo {} >> ../description.txt
curl -H "$API_TOKEN" -sL https://api.github.com/repos/rashevskyv/dbi/releases/latest \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/dragonflylee/Awoo-Installer/releases/latest \
  | jq '.name' \
  | xargs -I {} echo {} >> ../description.txt
curl -H "$API_TOKEN" -sL https://api.github.com/repos/dragonflylee/Awoo-Installer/releases/latest \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/Team-Neptune/DeepSea-Toolbox/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/NX-Activity-Log/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/exelix11/SwitchThemeInjector/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/J-D-K/JKSV/releases/latest \
  | jq '.name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/CaiMiao/Tencent-switcher-GUI/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/HamletDuFromage/aio-switch-updater/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/xfangfang/wiliwili/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/PoloNX/SimpleModDownloader/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/nadrino/SimpleModManager/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/dragonflylee/switchfin/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/XITRIX/Moonlight-Switch/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/joel16/NX-Shell/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/fortheusers/hb-appstore/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/masagrator/ReverseNX-Tool/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/XorTroll/Goldleaf/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/dezem/Safe_Reboot_Shutdown/releases/latest \
  | jq '.tag_name' \
...
#curl -H "$API_TOKEN" -sL https://api.github.com/repos/mrdude2478/Switch-Firmware-Dumper/releases/latest \
#  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/Switch-Firmware-Dumper/releases/latest \
  | jq '.tag_name' \
  | xargs -I {} echo Firmware-Dumper {} >> ../description.txt
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/Switch-Firmware-Dumper/releases/latest \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/StarDustCFW/Haku33/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/nx-ovlloader/releases/latest \
  | jq '.tag_name' \
...
#curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/Tesla-Menu/releases/latest \
#  | jq '.tag_name' \
...
### mkdir /config/Tesla-Menu
mkdir -p ./config/Tesla-Menu
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/Ultrahand-Overlay/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/ovl-sysmodules/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/Status-Monitor-Overlay/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/EdiZon-Overlay/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/ReverseNX-RT/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/sys-clk/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/emuiibo/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/ldn_mitm/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/QuickNTP/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/zdm65477730/sysdvr-overlay/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/ndeadly/MissionControl/releases/latest \
  | jq '.tag_name' \
...
curl -H "$API_TOKEN" -sL https://api.github.com/repos/o0Zz/sys-con/releases/latest \
  | jq '.name' \
